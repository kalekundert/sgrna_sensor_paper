...
\author{Kale Kundert, James Lucas, Kyle E. Watters, Christina M. Fitzsimmons, Benjamin L. Oakes, Christof Fellman, Andrew H. Ng, Ben M. Heineike, David Savage, Jennifer A. Doudna, Hana El-Samad, Tanja Kortemme}
\maketitle{}
...
We began by seeking to understand which of the sgRNA stems would be sensitive to the presence of an aptamer.

  %§ We found that designing specific \apo{} and \holo{} state base-pairing interactions was more effective than simply replacing part of a stem with the aptamer.
  
  %§  This isn't really a ground-breaking idea...
  
  %§ How to best tie 1e into the argument?  "We convinced ourselves that these designs were truly responding to theophylline by performing titrations as if \reffig{1}e."
