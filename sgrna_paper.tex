...
\fig{2}
 ...
 %
 (a) A schematic of the screen used to isolate \ligrnaF{}.  The numbers above the arrows indicate approximate library sizes at each step.  G1, G2, R1, and R2 refer to the first and second spacers targeting GFP and RFP, respectively.
...
\suppfig{in-vitro-in-vivo}
 ...
 \figonecol{supp_mat/in_vitro_in_vivo}
...
\suppfig{affinity-correlation}
 ...
 \figonecol{supp_mat/affinity_correlation}
