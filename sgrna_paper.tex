...
%
% ^.
 (e) Efficiency of \invitro{} Cas9 cleavage of DNA in the presence and absence of 10mM theophylline for selected ligRNAs.  Design numbers refer to \refsupptab{rational-designs} and are color-coded by aptamer insertion sites.  Percent cut values (bottom) are the average of at least two experiments.  All data are from a single gel, but some lanes were excluded for clarity.
