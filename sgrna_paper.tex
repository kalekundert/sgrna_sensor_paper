...
\supptab{components}
    ...
    \tabtwocol{supp_mat/components}

    \captitle{Miscellaneous DNA sequences used in this project.}

\supptab{libraries}

    \tabtwocol{supp_mat/library_sequences}
