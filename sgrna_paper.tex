...
\fig{1}
 ...
 %
 (a) A schematic illustrating our expectation that we could engineer an sgRNA 
 to only adopt its native fold and assemble into a functional Cas9 complex in 
 the presence of a small molecule ligand.
 %
...
\fig{3}
 ...
 \captitle{Parallel control with two ligands}
