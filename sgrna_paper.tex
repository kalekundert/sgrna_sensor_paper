...
%¶ It would be useful to regulate Cas9

    %§ Cas9 is amazing

    %§ But for reason X, Y, Z, it would be good to have better control.

    %§ Briefly review Cas9-based strategies

    %§ End by suggesting that sgRNA-based strategies are the most modular.
...
The alternative is to focus on engineering Cas9's guide RNA (sgRNA).  
